      ...
      <form class="register-form">
        ...
        <div class="username-input form-outline b-4">
          <div class="input-wrapper">
            ...
            <input id="form3Example3" class="form-control form-control-lg" placeholder="输入用户名" v-model="username" />
          </div>
        </div>
        ...
        <div class="name-input form-outline mb-4">
          <div class="input-wrapper">
            ...
            <input id="form3Example3" class="form-control form-control-lg" placeholder="输入名称" v-model="name" />
          </div>
        </div>
        ...
        <div class="email-input form-outline mb-3">
          <div class="input-wrapper">
            ...
            <input type="email" id="form3Example4" class="form-control form-control-lg" placeholder="输入电子邮箱"
              v-model="email" />
          </div>
        </div>
        <!-- Password input -->
  ...
  methods: {
    register() {
      ...
      if (this.password.length < 8) {
        errors.push("密码长度小于 8");
      }
      else if (!regex.test(this.password)) {
        errors.push("密码需至少包含数字、特殊符号和一个大写英文字母");
      }
      if (!emailRegex.test(this.email)) {
        errors.push("电子邮箱格式错误");
      }
      if (this.username == "") {
        errors.push("用户名不得为空");
      }
